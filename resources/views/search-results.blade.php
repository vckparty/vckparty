                ...
                <tbody>
                    @foreach($searchResults as $key => $searchResult)
                        <tr data-entry-id="{{ $searchResult->id }}">
                            <td>
                                <br>
                                    @if(!empty($searchResult->selected))
                            ...
                            <td>
                                @can('districtposting_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.districtpostings.show', $searchResult->id) }}" target="_blank">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
                            ...
                            <td>
                                {{ $searchResult->applied_post ?? '' }}
                            </td>
                            <td>
                                {{ $searchResult->current_post ?? '' }}
                            </td>
                            <td>
