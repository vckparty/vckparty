...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.districtpostings.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('applied_post') ? 'is-invalid' : '' }}" type="text" name="applied_post" id="applied_post" value="{{ old('applied_post', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('assembly_name') ? 'is-invalid' : '' }}" type="text" name="assembly_name" id="assembly_name" value="{{ old('assembly_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_division') ? 'is-invalid' : '' }}" type="text" name="social_division" id="social_division" value="{{ old('social_division', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('join_year') ? 'is-invalid' : '' }}" type="text" name="join_year" id="join_year" value="{{ old('join_year', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('marrital_status') ? 'is-invalid' : '' }}" type="text" name="marrital_status" id="marrital_status" value="{{ old('marrital_status', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('permanent_address') ? 'is-invalid' : '' }}" name="permanent_address" id="permanent_address">{{ old('permanent_address') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('communication_address') ? 'is-invalid' : '' }}" name="communication_address" id="communication_address">{{ old('communication_address') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('payment_status') ? 'is-invalid' : '' }}" name="payment_status" id="payment_status">{{ old('payment_status') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('selected_post') ? 'is-invalid' : '' }}" type="text" name="selected_post" id="selected_post" value="{{ old('selected_post', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('photo_1') ? 'is-invalid' : '' }}" type="text" name="photo_1" id="photo_1" value="{{ old('photo_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('receipt_1') ? 'is-invalid' : '' }}" type="text" name="receipt_1" id="receipt_1" value="{{ old('receipt_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('receipt_2') ? 'is-invalid' : '' }}" type="text" name="receipt_2" id="receipt_2" value="{{ old('receipt_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('receipt_3') ? 'is-invalid' : '' }}" type="text" name="receipt_3" id="receipt_3" value="{{ old('receipt_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('document_1') ? 'is-invalid' : '' }}" type="text" name="document_1" id="document_1" value="{{ old('document_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('document_2') ? 'is-invalid' : '' }}" type="text" name="document_2" id="document_2" value="{{ old('document_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('document_3') ? 'is-invalid' : '' }}" type="text" name="document_3" id="document_3" value="{{ old('document_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('document_4') ? 'is-invalid' : '' }}" type="text" name="document_4" id="document_4" value="{{ old('document_4', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('document_5') ? 'is-invalid' : '' }}" type="text" name="document_5" id="document_5" value="{{ old('document_5', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('document_6') ? 'is-invalid' : '' }}" type="text" name="document_6" id="document_6" value="{{ old('document_6', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('document_7') ? 'is-invalid' : '' }}" type="text" name="document_7" id="document_7" value="{{ old('document_7', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('document_8') ? 'is-invalid' : '' }}" type="text" name="document_8" id="document_8" value="{{ old('document_8', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('document_9') ? 'is-invalid' : '' }}" type="text" name="document_9" id="document_9" value="{{ old('document_9', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('document_10') ? 'is-invalid' : '' }}" type="text" name="document_10" id="document_10" value="{{ old('document_10', '') }}">
