...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.pondicheryapplication.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pondicheryapplications.update", [$pondicheryapplication->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.pondicheryapplication.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $pondicheryapplication->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('categorypondichery') ? 'is-invalid' : '' }}" name="categorypondichery_id" id="categorypondichery_id">
                    @foreach($categorypondicheries as $id => $categorypondichery)
                        <option value="{{ $id }}" {{ ($pondicheryapplication->categorypondichery ? $pondicheryapplication->categorypondichery->id : old('categorypondichery_id')) == $id ? 'selected' : '' }}>{{ $categorypondichery }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('subcategorypondichery') ? 'is-invalid' : '' }}" name="subcategorypondichery_id" id="subcategorypondichery_id">
                    @foreach($subcategorypondicheries as $id => $subcategorypondichery)
                        <option value="{{ $id }}" {{ ($pondicheryapplication->subcategorypondichery ? $pondicheryapplication->subcategorypondichery->id : old('subcategorypondichery_id')) == $id ? 'selected' : '' }}>{{ $subcategorypondichery }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('subsubcategory') ? 'is-invalid' : '' }}" name="subsubcategory_id" id="subsubcategory_id">
                    @foreach($subsubcategories as $id => $subsubcategory)
                        <option value="{{ $id }}" {{ ($pondicheryapplication->subsubcategory ? $pondicheryapplication->subsubcategory->id : old('subsubcategory_id')) == $id ? 'selected' : '' }}>{{ $subsubcategory }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('districtspondichery') ? 'is-invalid' : '' }}" name="districtspondichery_id" id="districtspondichery_id">
                    @foreach($districtspondicheries as $id => $districtspondichery)
                        <option value="{{ $id }}" {{ ($pondicheryapplication->districtspondichery ? $pondicheryapplication->districtspondichery->id : old('districtspondichery_id')) == $id ? 'selected' : '' }}>{{ $districtspondichery }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('pondicheryassemblys') ? 'is-invalid' : '' }}" name="pondicheryassemblys_id" id="pondicheryassemblys_id">
                    @foreach($pondicheryassemblys as $id => $pondicheryassemblys)
                        <option value="{{ $id }}" {{ ($pondicheryapplication->pondicheryassemblys ? $pondicheryapplication->pondicheryassemblys->id : old('pondicheryassemblys_id')) == $id ? 'selected' : '' }}>{{ $pondicheryassemblys }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Pondicheryapplication::SOCIAL_MEDIAS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('social_medias') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="social_medias_{{ $key }}" name="social_medias" value="{{ $key }}" {{ old('social_medias', $pondicheryapplication->social_medias) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facebook') ? 'is-invalid' : '' }}" type="text" name="facebook" id="facebook" value="{{ old('facebook', $pondicheryapplication->facebook) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('twitter') ? 'is-invalid' : '' }}" type="text" name="twitter" id="twitter" value="{{ old('twitter', $pondicheryapplication->twitter) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('whatsapp_number') ? 'is-invalid' : '' }}" type="text" name="whatsapp_number" id="whatsapp_number" value="{{ old('whatsapp_number', $pondicheryapplication->whatsapp_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $pondicheryapplication->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('youtube_channel') ? 'is-invalid' : '' }}" type="text" name="youtube_channel" id="youtube_channel" value="{{ old('youtube_channel', $pondicheryapplication->youtube_channel) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instagram') ? 'is-invalid' : '' }}" type="text" name="instagram" id="instagram" value="{{ old('instagram', $pondicheryapplication->instagram) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_post') ? 'is-invalid' : '' }}" type="text" name="current_post" id="current_post" value="{{ old('current_post', $pondicheryapplication->current_post) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Pondicheryapplication::GENDER_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('gender') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="gender_{{ $key }}" name="gender" value="{{ $key }}" {{ old('gender', $pondicheryapplication->gender) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dob') ? 'is-invalid' : '' }}" type="text" name="dob" id="dob" value="{{ old('dob', $pondicheryapplication->dob) }}" required>
                @if($errors->has('dob'))
                    <div class="invalid-feedback">
                        {{ $errors->first('dob') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mother') ? 'is-invalid' : '' }}" type="text" name="mother" id="mother" value="{{ old('mother', $pondicheryapplication->mother) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('father') ? 'is-invalid' : '' }}" type="text" name="father" id="father" value="{{ old('father', $pondicheryapplication->father) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Pondicheryapplication::MARRITAL_STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('marrital_status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="marrital_status_{{ $key }}" name="marrital_status" value="{{ $key }}" {{ old('marrital_status', $pondicheryapplication->marrital_status) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('husband_wife_name') ? 'is-invalid' : '' }}" type="text" name="husband_wife_name" id="husband_wife_name" value="{{ old('husband_wife_name', $pondicheryapplication->husband_wife_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('education') ? 'is-invalid' : '' }}" type="text" name="education" id="education" value="{{ old('education', $pondicheryapplication->education) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('profession') ? 'is-invalid' : '' }}" type="text" name="profession" id="profession" value="{{ old('profession', $pondicheryapplication->profession) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('join_date') ? 'is-invalid' : '' }}" type="text" name="join_date" id="join_date" value="{{ old('join_date', $pondicheryapplication->join_date) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('permanent_address') ? 'is-invalid' : '' }}" name="permanent_address" id="permanent_address" required>{{ old('permanent_address', $pondicheryapplication->permanent_address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('communication_address') ? 'is-invalid' : '' }}" name="communication_address" id="communication_address" required>{{ old('communication_address', $pondicheryapplication->communication_address) }}</textarea>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Pondicheryapplication::SOCIAL_CATEGORY_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('social_category') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="social_category_{{ $key }}" name="social_category" value="{{ $key }}" {{ old('social_category', $pondicheryapplication->social_category) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{{ old('notes', $pondicheryapplication->notes) }}</textarea>
                @if($errors->has('notes'))
                    <div class="invalid-feedback">
                        {{ $errors->first('notes') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_status') ? 'is-invalid' : '' }}" type="text" name="payment_status" id="payment_status" value="{{ old('payment_status', $pondicheryapplication->payment_status) }}" required>
